package com.example.g.personalmemo.faceserver;
...
import com.example.g.personalmemo.model.FaceRegisterInfo;
import com.example.g.personalmemo.util.ImageUtil;
...
public class FaceServer {
    ...
    public static final String SAVE_IMG_DIR = "user" + File.separator + "imgs";
    private static final String SAVE_FEATURE_DIR = "user" + File.separator + "features";
